...
public class CategoriaMessage {
    ...
    public static final String EXISTE_CATEGORIA_POR_NOMBRE_ESTADO_ACTIVO = "Ya existe una categoría con el nombre: %s";
    public static final String NOMBRE_NO_NULO = "El nombre no puede ser nulo";
    public static final String NOMBRE_NO_VACIO = "El nombre no puede estar vacío";
    ...
    public static final String EXISTE_OTRA_CATEGORIA_POR_NOMBRE = "Ya existe una categoría con el nombre: %s";
